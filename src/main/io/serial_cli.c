...
const clivalue_t valueTable[] = {
...
#ifdef NAV
    { "nav_alt_p",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.P8[PIDALT]) },
    { "nav_alt_i",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.I8[PIDALT]) },
    { "nav_alt_d",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.D8[PIDALT]) },

    { "nav_vel_p",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.P8[PIDVEL]) },
    { "nav_vel_i",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.I8[PIDVEL]) },
    { "nav_vel_d",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.D8[PIDVEL]) },

    { "nav_pos_p",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.P8[PIDPOS]) },
    { "nav_pos_i",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.I8[PIDPOS]) },
    { "nav_pos_d",                  VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.D8[PIDPOS]) },

    { "nav_posr_p",                 VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.P8[PIDPOSR]) },
    { "nav_posr_i",                 VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.I8[PIDPOSR]) },
    { "nav_posr_d",                 VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.D8[PIDPOSR]) },

    { "nav_navr_p",                 VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.P8[PIDNAVR]) },
    { "nav_navr_i",                 VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.I8[PIDNAVR]) },
    { "nav_navr_d",                 VAR_UINT8  | PROFILE_VALUE, 0, .config.minmax = { 0,  255 }, PG_PROFILE, offsetof(profile_t, pidProfile.D8[PIDNAVR]) },
    ...
    { "yaw_p_limit",                VAR_UINT16 | PROFILE_VALUE, 0,  .config.minmax = { YAW_P_LIMIT_MIN, YAW_P_LIMIT_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.yaw_p_limit)},
    ...
    { "d_pitch",                    VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.D8[FD_PITCH])},
    { "p_roll",                     VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.P8[FD_ROLL])},
    { "i_roll",                     VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.I8[FD_ROLL])},
    { "d_roll",                     VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.D8[FD_ROLL])},
    { "p_yaw",                      VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.P8[FD_YAW])},
    { "i_yaw",                      VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.I8[FD_YAW])},
    { "d_yaw",                      VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.D8[FD_YAW])},

    { "p_level",                    VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.P8[PIDLEVEL])},
    { "i_level",                    VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.I8[PIDLEVEL])},
    { "d_level",                    VAR_UINT8  | PROFILE_VALUE, 0,  .config.minmax = { PID_MIN,  PID_MAX } , PG_PROFILE, offsetof(profile_t, pidProfile.D8[PIDLEVEL])},
